const CACHE_NAME = 'aakash-ai-v21';
const BASE = '/aakash-ai/';
const ASSETS = [
  BASE, BASE+'index.html', BASE+'icons.js', BASE+'crypto.js', BASE+'state.js',
  BASE+'tools.js', BASE+'web.js', BASE+'providers.js', BASE+'firebase-sync.js', BASE+'brain.js', BASE+'ai.js', BASE+'chat.js',
...
self.addEventListener('fetch', event => {
  ...
  const passthrough = ['api.anthropic.com','generativelanguage.googleapis.com','fonts.googleapis.com','fonts.gstatic.com','r.jina.ai','api.allorigins.win','corsproxy.io','api.codetabs.com','api.openai.com','api.elevenlabs.io','api.groq.com','api.x.ai','openrouter.ai','api.mistral.ai','api.together.xyz','api-inference.huggingface.co','firestore.googleapis.com','www.gstatic.com','firebase.googleapis.com','firebaseio.com'];
