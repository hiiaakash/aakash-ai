...
function getContext() {
  ...
  c += `\nNOTE: WEB READER active — jab user koi URL/link share kare, content automatically fetch hoke tere context mein aa jaata hai [FETCHED WEB CONTENT] tag mein. Tu seedha padh ke jawab de, user ko batane ki zarurat nahi ki tune kaise padha.`;
